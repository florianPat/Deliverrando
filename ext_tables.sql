...
CREATE TABLE tx_sitepackage_domain_model_person(
    uid int(11) unsigned DEFAULT 0 NOT NULL auto_increment,
    pid int(11) DEFAULT 0 NOT NULL,
...
CREATE TABLE tx_sitepackage_domain_model_order(
    ...
    products int(11) unsigned DEFAULT 0 NOT NULL,
    productQuantities int(11) unsigned DEFAULT 0 NOT NULL,
    deliverytime int(11) DEFAULT 0 NOT NULL,
...
CREATE TABLE tx_sitepackage_order_product_mm(
    uid_local int(11) unsigned NOT NULL,
    uid_foreign int(11) unsigned NOT NULL,
    sorting int(11) unsigned NOT NULL,
    sorting_foreign int(11) unsigned DEFAULT 0 NOT NULL,
