...
class LargePictureWithTextProcessor implements DataProcessorInterface
{
    ...
    public function process(ContentObjectRenderer $cObj, array $contentObjectConfiguration, array $processorConfiguration, array $processedData)
    {
        ...
        $object = $fileRepository->findByRelation('tt_content', 'image', 18);
        $url = $object[0]->getPublicUrl();

        $objectManager = GeneralUtility::makeInstance(\TYPO3\CMS\Extbase\Object\ObjectManager::class);
        $sysTemplateRepository = $objectManager->get(\MyVendor\SitePackage\Domain\Repository\SysTemplatesRepository::class);
